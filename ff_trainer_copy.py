...
class trainer:
    ...
    def feed_interpolated_input(self, x):
        if self.phase == 'gtrns' and floor(self.resl)>2 and floor(self.resl)<=self.max_resl:
            ...
            x_low = x.clone()
            print("ZEZEZEZEEZEEZEZEZEZE")
            print(type(x_low))

            for i in range(x_low.size(0)):
                print("ZAZZAZAZAZAZAZAZZAAZ")
                print(type(x_low[i]))
    ...
    def train(self):
        ...
        for step in range(config.start_res, self.max_resl+1+5):
            print("____________________________________________"*3)
            print("step :")
            print(step)
            print("____________________________________________"*3)
            for iter in tqdm(range(0,20000, self.loader.batchsize)):
                print("***********************************************"*3)
                print("iter :")
                print(iter)
                print("***********************************************"*3)
                ...
                sample_batch = self.loader.get_batch()
                print("OUEOUEOUEOUEOUEOUE")
                print(type(sample_batch['image']))
                ...
                try :
                    ...
                    print("selfz is already a variable")
